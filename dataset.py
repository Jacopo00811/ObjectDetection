...
# Example usage of get_gt_boxes

# Initialize the dataset
dataset = CroppedProposalDataset('train', transform=transform, size=256)

print(f"Number of xml files: {len(dataset.list_of_xml_dir)}")
# Get ground truth boxes for the first image directory
xml_dir = dataset.list_of_xml_dir[0]
print(f"XML file: {xml_dir}")
gt_boxes = dataset.get_gt_boxes(xml_dir)

print(f"Ground truth boxes for {xml_dir}:")
for box in gt_boxes:
    print(box)