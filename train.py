...
def check_accuracy(model, dataloader, device, save_dir=None):
    ...
    with torch.no_grad():
        for data in dataloader:
            ...
            keep = nms(predicted_boxes, confidence_scores, iou_threshold=hyperparameters["iou_threshold"])
            ...
            for gt_box in ground_truth_boxes:
                best_iou = 0
                for pred_box, score in zip(filtered_boxes, filtered_scores):
        ...
        ap_score = AveragePrecision(task='binary')
